...
From Undecidability Require Import TM.Util.Prelim TM.Util.Relations.
From Complexity.Libs Require Import Vectors VectorDupfree.
...
Proof. now induction xs using Vector.caseS'. Qed.
  ...
  Proof.
    ...
    - destruct (Fin.eqb i i') eqn:Eqb; cbn in *.
      ...
      + destruct (lookup_index_vector I' i) as [j' | ] eqn:El.
        * induction j using Fin.caseS'; cbn in *.
        ...
        * exfalso. induction j using Fin.caseS'; cbn in *.
          -- subst. enough (Fin.eqb i i = true) by congruence. now apply Fin.eqb_eq.
...
#[export] Hint Extern 1 (LiftTapes _ _ ⊨ _) => apply LiftTapes_Realise; [ smpl_dupfree | ] : TMdb.
#[export] Hint Extern 1 (LiftTapes _ _ ⊨c(_) _) => apply LiftTapes_RealiseIn; [ smpl_dupfree | ] : TMdb.
#[export] Hint Extern 1 (projT1 (LiftTapes _ _) ↓ _) => apply LiftTapes_Terminates; [ smpl_dupfree | ] : TMdb.
