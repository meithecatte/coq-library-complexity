From Complexity.Libs Require Import Vectors.
From Complexity.TM Require Export Lifting.Lifting TM_facts Code.Code.
From Undecidability.TM Require Export Util.Prelim.
From Undecidability.TM Require Export Combinators.Combinators.
From Undecidability.TM Require Import Single.EncodeTapes. (* EncodeTapes defines boundary *)

(* re-export just this type *)
Notation boundary := boundary.
