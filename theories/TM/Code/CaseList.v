...
Section CaseList.
  ...
  Proof.
    ...
    {
      intros tin ((), tout) H. intros ls rs x l HTin. TMSimp.
  ...
  Proof.
    ...
    {
      intros tin ((), tout) H. intros ls rs x l s HTin0 HRight. TMSimp.
  ...
  Proof.
    ...
    { unfold CaseList. TM_Correct. eapply M1_Realise. eapply Skip_cons_Realise. }
    {
      ...
      destruct HEncL as (ls&HEncL&Hs0). pose proof HRight as (ls'&rs'&HRight'&Hs1). TMSimp.
      destruct l as [ | x l'] in *; cbn in *; TMSimp.
      { (* nil *)
        split; auto.
      ...
      { (* cons *)
        ...
        - repeat split; auto. hnf. eexists. simpl_tape. rewrite List.map_map. cbn. simpl_list. split.
          + f_equal. f_equal. rewrite !map_app, !map_map. now simpl_list.
          + rewrite tl_length. simpl_list. cbn. unfold size. lia.
      }
    }
  Qed.
  ...
  Proof.
    ...
    }
    {
      ...
      }
      {
        ...
        { rewrite !map_map, List.map_app, <- app_assoc, !map_map. do 4 eexists; eauto. split.
...
From Complexity.TM.Hoare Require Import HoareLogic HoareRegister HoareTactics.
...
Section CaseList.
  ...
  Proof. unfold withSpace.
    ...
    - intros tin yout tout H HEnc. cbn in *.
      specialize (HEnc Fin0) as HEnc0; specialize (HEnc Fin1) as HEnc1; simpl_vector in *; cbn in *.
      modpon H. destruct yout, xs; cbn in *; try contradiction; eauto.
