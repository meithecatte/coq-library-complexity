...
From Complexity Require Import TM.Code.CodeTM TM.Compound.TMTac.
From Complexity Require Export TM.Compound.CopySymbols.
From Undecidability.TM.Compound Require Export MoveToSymbol.
...
From Complexity Require Import TM.Lifting.LiftAlphabet.
...
Section Move.
  ...
  Proof.
    ...
    { reflexivity. }
    {
      ...
      destruct HEncX as (ls&HEncX). TMSimp. rewrite HCod;cbn.
  ...
  Proof.
    ...
    { reflexivity. }
    {
      ...
      destruct HEncX as (ls&HEncX). unfold size in *. TMSimp.
