...
Section CaseSum.
  ...
  Proof.
    ...
    { Unshelve. 4,10,11: constructor. all: cbn. all: lia. }
    {
      ...
      intros s ss HEncS. destruct HEncS as (ls&HEncS&Hss). TMSimp.
  ...
  Section SumConstr.
    ...
    Proof.
      ...
      {
        intros tin (()&tout) H.
        cbn. intros x s HEncX. destruct HEncX as (ls&HEncX). TMSimp.
    ...
    Proof.
      ...
      {
        intros tin (()&tout) H.
        cbn. intros y ss HEncY. destruct HEncY as (ls&HEncY&Hss). TMSimp.
        hnf. simpl_tape. eexists. split.
        - cbn. rewrite !List.map_map. f_equal.
        - cbn. rewrite tl_length. lia.
      }
