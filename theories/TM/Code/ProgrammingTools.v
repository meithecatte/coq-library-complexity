From Complexity.TM.Code Require Export CodeTM Copy WriteValue ChangeAlphabet.
From Complexity.TM.Compound Require Export TMTac Multi.
Require Export Undecidability.TM.Basic.Mono.
Require Import Lia.
