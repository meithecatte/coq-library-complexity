...
From Complexity.TM Require Import CaseNat CaseList CaseSum. (* [TM.Code.CaseSum] contains [Constr_Some] and [Constr_None]. *)
...
Section Length.
  ...
  Proof.
    ...
    }
    {
      ...
      - exists CaseList_steps_nil, 0. repeat split; cbn in *; try lia.
        ...
        intros tmid b (HCaseList&HInjCaseList); TMSimp. modpon HCaseList. destruct b; cbn in *; [contradiction | auto].
      - exists (CaseList_steps_cons x), (1 + Reset_steps x + Constr_S_steps). repeat split; cbn in *; try lia.
        ...
        intros tmid b (HCaseList&HInjCaseList); TMSimp. modpon HCaseList. destruct b; cbn in *; auto;
          try contradiction; modpon HCaseList.
  ...
  Proof.
    ...
    }
    {
      ...
      {
        modpon HLastStep.
        destruct xs as [ | x xs']; auto; try contradiction; TMSimp.
  ...
  Proof.
      ...
      - apply Length_Step_Terminates. }
    {
      ...
      - intros b tmid HStep. hnf in HStep. modpon HStep.
        destruct b as [ () | ], xs as [ | x xs']; cbn in *; auto; try contradiction; modpon HStep.
