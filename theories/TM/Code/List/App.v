...
From Complexity.TM Require Import ProgrammingTools Code.Copy.
...
Section Append.
  ...
  Proof.
    ...
    }
    {
      ...
      destruct HEncXs as (ls1&HEncXs&Hs0), HEncYs as (ls2&HEncYs&Hs1). TMSimp.
  ...
  Proof.
    ...
    }
    {
      ...
      intros tmid (). intros H; TMSimp. modpon H.
