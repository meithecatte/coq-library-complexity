...
From Complexity.TM.L Require Import Alphabets CaseCom.
From Complexity.TM.Code Require Import List.App CaseList CaseNat.
...
(* Add a singleton list of tokens to [Q] *)
...
Proof.
  ...
  }
  {
    ...
    TMSimp ( simpl_not_in; unfold sigPro, sigCom in * ). rename H into HWriteNil, H0 into HWriteO, H2 into HLoop.
...
Proof.
  ...
  }
  {
    ...
    { hnf. do 3 eexists; repeat split; cbn in *; unfold sigPro in *; cbn in *; TMSimp; eauto. }
  }
Qed.
