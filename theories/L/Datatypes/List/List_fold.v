...
From Complexity.L.Datatypes Require Import List_enc LBool.
...
Section forallb. 
  ...
  Global Instance termT_forallb : computableTime' (@forallb X) (fun f fT => (1, fun l _ => (forallb_time (callTime fT) l, tt))). 
  Proof.
    extract.
    solverec. 
