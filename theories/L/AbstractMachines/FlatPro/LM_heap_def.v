...
From Complexity.Libs Require Import ARS MoreBase.
Require Export Complexity.L.AbstractMachines.FlatPro.Programs.
...
Section Semantics.
  ...
  Proof. intros s. eapply dec_transfer. apply is_halt_state_correct.
  exact _. Defined. (* because dec *)
