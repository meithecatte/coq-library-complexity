...
Section In_Dec.
  ...
  Proof using X_dec. eapply dec_transfer. eapply in_dec_correct. exact _. Defined.
...
Section In_nth.
  ...
  Proof.
    ...
    - induction v using caseS'.
      induction i using Fin.caseS'; intros;
       cbn in *; subst; econstructor; eauto.
  Qed.
  ...
  Proof.
    ...
    - destruct_vector_in.
      + exists Fin.F1. auto.
      + specialize (IHv H) as (i&<-). exists (Fin.FS i). auto.
  Qed.
